...
object Day6 extends AdventApp[List[Int]](year = 2021, day = 6) {
  ...
  def fishDays(firstDay: List[Input]): LazyList[Map[Int, Long]] = fishDays(firstDay.flatten.groupMapReduce(identity)(_ => 1L)(_ + _))
  def fishDays(firstDay: Map[Int, Long]): LazyList[Map[Int, Long]] = firstDay #:: fishLoop(firstDay)
